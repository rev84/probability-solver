...
var bernoulli, bernoulli_decode, bernoulli_encode, bernoulli_init, bernoulli_normal, bernoulli_start, bernoulli_std, bernoulli_switch, bernoulli_title_edit, bernoulli_title_save, bernoulli_tweet, cdf, combi_memorized, format_log_fixed, fraction_html, get_value, progress_bar_html, switch_mode, toJPUnit, tweet;
...
bernoulli_normal = function(p, n, x, mode) {
  ...
  for (j = 0, len = ary.length; j < len; j++) {
    ...
    c = isNaN(c) ? combi_memorized(n.toNumber(), i) : c;
